        ...
        return;
                    ...
                    try {
                        ...
                        for (var i = 0; i < torrents.length; i++) {
                            ...
                            if (parsedYear > 1900 && yearDifference > 5) {
            ...
            // Стратегія 3: fallback без року (розширений пошук)
            if (normalizedCard.original_title || normalizedCard.title) {
                searchStrategies.push({
                    title: (normalizedCard.original_title || normalizedCard.title).trim(),
                    year: null,
                    exact: false,
                    name: "Fallback No Year"
                });
            }
